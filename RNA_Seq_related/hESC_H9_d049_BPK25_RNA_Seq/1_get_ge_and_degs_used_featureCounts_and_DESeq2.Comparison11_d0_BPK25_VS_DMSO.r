...
######################################################
# Comparison11: d0_BPK25_vs_DMSO
#####################################################
# 绘制 MA plot
library(geneplotter)
ma_for_d0_BPK25_vs_DMSO <- lfcShrink(dds_filter1_deseq, contrast=c("groups", "d0_BPK25", "d0_DMSO"), type="normal", lfcThreshold=1)
pdf("Comparison11_d0_BPK25_vs_DMSO_MA_plot.pdf", width = 7, height = 5)
plotMA(ma_for_d0_BPK25_vs_DMSO, main="MA_plot", ylim=c(-3,3), cex=.8)
abline(h=c(-1,1), col="dodgerblue", lwd=2)
dev.off()

# 差异基因分析
degs_for_d0_BPK25_vs_DMSO <- results(dds_filter1_deseq, contrast=c("groups", "d0_BPK25", "d0_DMSO"))
head(degs_for_d0_BPK25_vs_DMSO)
summary(degs_for_d0_BPK25_vs_DMSO)
...
# stat by padj filter
table(degs_for_d0_BPK25_vs_DMSO$padj<0.05)
# FALSE 
# 22096 
table(degs_for_d0_BPK25_vs_DMSO$padj<0.05 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange >= 0.585)
# FALSE 
# 22096 
table(degs_for_d0_BPK25_vs_DMSO$padj<0.05 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange <= -0.585)
# FALSE 
# 22096 
table(degs_for_d0_BPK25_vs_DMSO$padj<0.05 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange >= 1)
# FALSE 
# 22096 
table(degs_for_d0_BPK25_vs_DMSO$padj<0.05 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange <= -1)
# FALSE 
# 22096 
table(degs_for_d0_BPK25_vs_DMSO$padj<0.01 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange >= 1)
# FALSE 
# 22096 
table(degs_for_d0_BPK25_vs_DMSO$padj<0.01 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange <= -1)
# FALSE 
...
table(degs_for_d0_BPK25_vs_DMSO$pvalue<0.05)
# FALSE  TRUE 
# 21831   265 
table(degs_for_d0_BPK25_vs_DMSO$pvalue<0.05 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange >= 0.585)
# FALSE  TRUE 
# 22018    78 
table(degs_for_d0_BPK25_vs_DMSO$pvalue<0.05 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange <= -0.585)
# FALSE  TRUE 
# 22019    77 
table(degs_for_d0_BPK25_vs_DMSO$pvalue<0.05 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange >= 1)
# FALSE  TRUE 
# 22044    52 
table(degs_for_d0_BPK25_vs_DMSO$pvalue<0.05 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange <= -1)
# FALSE  TRUE 
# 22045    51 
table(degs_for_d0_BPK25_vs_DMSO$pvalue<0.01 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange >= 1)
# FALSE  TRUE 
# 22089     7 
table(degs_for_d0_BPK25_vs_DMSO$pvalue<0.01 & degs_for_d0_BPK25_vs_DMSO$log2FoldChange <= -1)
# FALSE  TRUE 
...
degs_for_d0_BPK25_vs_DMSO_add_nc <- merge(as.data.frame(degs_for_d0_BPK25_vs_DMSO), dds_filter1_normalized_counts[,c("H9_0day_BPK25_rep1","H9_0day_BPK25_rep2","H9_0day_BPK25_rep3","H9_0day_DMSO_rep1","H9_0day_DMSO_rep2","H9_0day_DMSO_rep3")], by="row.names", sort=FALSE)
head(degs_for_d0_BPK25_vs_DMSO_add_nc)
#对列名进行修改
colnames(degs_for_d0_BPK25_vs_DMSO_add_nc)<- c('gene_id',"baseMean","log2FoldChange","lfcSE","stat","pvalue","padj","H9_0day_BPK25_rep1","H9_0day_BPK25_rep2","H9_0day_BPK25_rep3","H9_0day_DMSO_rep1","H9_0day_DMSO_rep2","H9_0day_DMSO_rep3")
# 增加基因信息
rownames(degs_for_d0_BPK25_vs_DMSO_add_nc) <- degs_for_d0_BPK25_vs_DMSO_add_nc$gene_id
head(degs_for_d0_BPK25_vs_DMSO_add_nc)
degs_all_add_geneInfo <- merge(degs_for_d0_BPK25_vs_DMSO_add_nc, exp_data[,c("gene_name","gene_type")], by="row.names", all.x = TRUE, sort = FALSE)
...
# 22096    15
# 输出全部数据
write.table(degs_all_add_geneInfo_sorted, "Comparison11_d0_BPK25_vs_DMSO_all_diff_exp_gene_info.xls", sep = '\t', col.names = TRUE, row.names=FALSE, quote = FALSE,na='')


# 追加 是否显著上下调的标签
res<-degs_for_d0_BPK25_vs_DMSO[which(degs_for_d0_BPK25_vs_DMSO$baseMean >= 0 &  degs_for_d0_BPK25_vs_DMSO$padj >= 0),]
head(res)
...
# [1] 22096     7
# 差异结果追加 经过 DESeq 标准化的 count 表达量
res_add_nc <- merge(as.data.frame(res), dds_filter1_normalized_counts[,c("H9_0day_BPK25_rep1","H9_0day_BPK25_rep2","H9_0day_BPK25_rep3","H9_0day_DMSO_rep1","H9_0day_DMSO_rep2","H9_0day_DMSO_rep3")], by="row.names", all.x = TRUE, sort = FALSE)
head(res_add_nc)
dim(res_add_nc)
# [1] 22096    14
#对列名进行修改
colnames(res_add_nc)<- c('gene_id',"baseMean" ,"log2FoldChange","lfcSE" ,"stat","pvalue","padj","up_down","H9_0day_BPK25_rep1","H9_0day_BPK25_rep2","H9_0day_BPK25_rep3","H9_0day_DMSO_rep1","H9_0day_DMSO_rep2","H9_0day_DMSO_rep3")
# 增加基因信息
...
# 保存数据
write.table(res_add_nc_add_geneInfo_sorted, "Comparison11_d0_BPK25_vs_DMSO_filtered_diff_exp_genes.baseMeanLe0_padjLe0.xls", sep = '\t', col.names = TRUE, row.names=FALSE, quote = FALSE,na='')
...
# [1]  0 16
##保存数据
write.table(resSig,"Comparison11_d0_BPK25_vs_DMSO_filtered_diff_exp_genes.FC2_padj0.01.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')


######################################################
# Volcano plot for Comparison11: d0_BPK25_vs_DMSO
#####################################################
library(ggplot2)
d0_BPK25_vs_DMSO <- read.csv("Comparison11_d0_BPK25_vs_DMSO_filtered_diff_exp_genes.baseMeanLe0_padjLe0.xls",header = TRUE, sep = "\t", check.names = FALSE, stringsAsFactors = FALSE)
d0_BPK25_vs_DMSO$up_down <- factor(d0_BPK25_vs_DMSO$up_down, levels = c("up", "non", "down"))

pdf("Comparison11_d0_BPK25_vs_DMSO_volcano_plot.pdf", width = 8, height = 6)
volcano<-ggplot(d0_BPK25_vs_DMSO,aes(x=log2FoldChange,y=-log10(padj))) 
volcano + geom_point(aes(color=up_down), size=1) +
  # scale_color_manual(values=c("tomato","grey","royalblue")) +
  scale_color_manual(values=c("grey","red")) +
  geom_point(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="MBD2",]$log2FoldChange, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="MBD2",]$padj)), colour ="gold", size = 1.5) + 
  geom_text(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="MBD2",]$log2FoldChange+0.1, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="MBD2",]$padj)+2, label="MBD2"), size=3, color="orange") +
  geom_point(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="MBD3",]$log2FoldChange, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="MBD3",]$padj)), colour ="gold", size = 1.5) + 
  geom_text(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="MBD3",]$log2FoldChange+0.1, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="MBD3",]$padj)+2, label="MBD3"), size=3, color="orange") +
  geom_point(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="CTCF",]$log2FoldChange, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="CTCF",]$padj)), colour ="gold", size = 1.5) + 
  geom_text(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="CTCF",]$log2FoldChange+0.1, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="CTCF",]$padj)+2, label="CTCF"), size=3, color="orange") +
  geom_point(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET1",]$log2FoldChange, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET1",]$padj)), colour ="gold", size = 1.5) + 
  geom_text(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET1",]$log2FoldChange+0.1, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET1",]$padj)+2, label="TET1"), size=3, color="orange") +
  geom_point(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET2",]$log2FoldChange, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET2",]$padj)), colour ="gold", size = 1.5) + 
  geom_text(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET2",]$log2FoldChange+0.1, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET2",]$padj)+2, label="TET2"), size=3, color="orange") +
  geom_point(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET3",]$log2FoldChange, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET3",]$padj)), colour ="gold", size = 1.5) + 
  geom_text(aes(x=d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET3",]$log2FoldChange+0.1, y=-log10(d0_BPK25_vs_DMSO[d0_BPK25_vs_DMSO$gene_name=="TET3",]$padj)+2, label="TET3"), size=3, color="orange") +
  ...
  labs(x = "log2FC", y = "-log10(padj)", title = "d0_BPK25_vs_DMSO Volcano plot") +
...
######################################################
# GSEA for  Comparison11: d0_BPK25_vs_DMSO
#####################################################
library(dplyr)
library(DOSE)
...
# 读入全部差异基因数据
# all_deseq <- read.csv("Comparison11_d0_BPK25_vs_DMSO_all_diff_exp_gene_info.xls", header = TRUE, sep = "\t", check.names = FALSE, stringsAsFactors = FALSE)
...
write.table(gse_GO_BP_rdb,"Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_BP_reults.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')

pdf("Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_BP_top1_plot.pdf", width = 12, height = 9)
gseaplot2(gse_GO_BP, geneSetID = 1, title = gse_GO_BP$Description[1], pvalue_table = TRUE)
dev.off()
pdf("Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_BP_top5_plot.pdf", width = 12, height = 9)
...
write.table(gse_GO_CC_rdb,"Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_CC_reults.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')

pdf("Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_CC_top1_plot.pdf", width = 12, height = 9)
gseaplot2(gse_GO_CC, geneSetID = 1, title = gse_GO_CC$Description[1], pvalue_table = TRUE)
dev.off()
pdf("Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_CC_top5_plot.pdf", width = 12, height = 9)
...
write.table(gse_GO_MF_rdb,"Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_MF_reults.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')

pdf("Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_MF_top1_plot.pdf", width = 12, height = 9)
gseaplot2(gse_GO_MF, geneSetID = 1, title = gse_GO_MF$Description[1], pvalue_table = TRUE)
dev.off()
pdf("Comparison11_d0_BPK25_vs_DMSO.all_GSEA_GO_MF_top5_plot.pdf", width = 12, height = 9)
...
write.table(gse_kegg_rdb,"Comparison11_d0_BPK25_vs_DMSO.all_GSEA_KEGG_reults.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')

pdf("Comparison11_d0_BPK25_vs_DMSO.all_GSEA_KEGG_top1_plot.pdf", width = 12, height = 9)
gseaplot2(gse_kegg, geneSetID = 1, title = gse_kegg$Description[1], pvalue_table = TRUE)
dev.off()
pdf("Comparison11_d0_BPK25_vs_DMSO.all_GSEA_KEGG_top5_plot.pdf", width = 12, height = 9)
...
# 由于没有显著差异基因，不能进一步进行 GO KEGG 分析
# 
# ##################################################################################
# # GO KEGG for Comparison11: d0_BPK25_vs_DMSO
# ##################################################################################
# library(clusterProfiler)
# library(org.Hs.eg.db)
# library(topGO)
# library(Rgraphviz)
# deg_info <- read.table("Comparison11_d0_BPK25_vs_DMSO_filtered_diff_exp_genes.FC2_padj0.01.xls",  sep = '\t', header = T, stringsAsFactors = F)
# head(deg_info)
# dim(deg_info)
# # 4814   16
...
# write.table(go,"Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_all_enrichment.results.txt", sep="\t", quote=F, row.names=F)
# head(go)
# dim(go)
# # 1020   10
...
# # GO ALL bar plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_all_enrichment.barplot.pdf", width = 10, height = 6 )
# barplot(go, showCategory=15, title = "GO ALL top15")
# dev.off()
# # GO ALL dot plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_all_enrichment.dotplot.pdf", width = 10, height = 6 )
...
# dim(GO_BP)
# # GO BP bar plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_BP_enrichment.barplot.pdf", width = 10, height = 6 )
# barplot(GO_BP, showCategory=10, title = "GO BP top10")
# dev.off()
# # GO BP dot plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_BP_enrichment.dotplot.pdf", width = 10, height = 6 )
# dotplot(GO_BP, showCategory=10, orderBy = "GeneRatio", title = "GO BP top10")
# dev.off()
# # GO BP network plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_BP_enrichment.network.pdf", width = 12, height = 12 )
# plotGOgraph(GO_BP)
# dev.off()
...
# dim(GO_CC)
# # GO CC bar plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_CC_enrichment.barplot.pdf", width = 10, height = 6 )
# barplot(GO_CC, showCategory=10, title = "GO CC top10")
# dev.off()
# # GO CC dot plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_CC_enrichment.dotplot.pdf", width = 10, height = 6 )
# dotplot(GO_CC, showCategory=10, orderBy = "GeneRatio", title = "GO CC top10")
# dev.off()
# # GO CC network plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_CC_enrichment.network.pdf", width = 12, height = 12 )
# plotGOgraph(GO_CC)
# dev.off()
...
# dim(GO_MF)
# # GO MF bar plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_MF_enrichment.barplot.pdf", width = 10, height = 6 )
# barplot(GO_MF, showCategory=10, title = "GO MF top10")
# dev.off()
# # GO MF dot plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_MF_enrichment.dotplot.pdf", width = 10, height = 6 )
# dotplot(GO_MF, showCategory=10, orderBy = "GeneRatio", title = "GO MF top10")
# dev.off()
# # GO MF network plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_GO_MF_enrichment.network.pdf", width = 12, height = 12 )
# plotGOgraph(GO_MF)
# dev.off()
...
# write.table(kegg_out,"Comparison11_d0_BPK25_vs_DMSO.DEGs_KEGG_enrichme.results.txt", sep="\t", quote=F, row.names=F)
# head(kegg_out)
# dim(kegg_out)
# # 20  9
# # kegg bar plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_KEGG_enrichme.barplot.pdf", width = 10, height = 6 )
# barplot(kegg, showCategory=10, title = "KEGG top10")
# dev.off()
# # kegg dot plot
# pdf("Comparison11_d0_BPK25_vs_DMSO.DEGs_KEGG_enrichme.dotplot.pdf", width = 10, height = 6 )
