...
# 差异分析
#### 差异分析 Comparison2: BPK25_12h_vs_DMSO ####
##### 绘制 MA plot #####
library(geneplotter)
ma_for_BPK25_12h_vs_DMSO <- lfcShrink(dds_filter1_deseq, contrast=c("groups", "BPK25_12h", "DMSO"), type="normal", lfcThreshold=1)
plotMA(ma_for_BPK25_12h_vs_DMSO, main="MA_plot", ylim=c(-6,6), cex=.8)
abline(h=c(-1,1), col="dodgerblue", lwd=2)
# 保存 MA plot pdf
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_MA_plot.pdf", width = 7, height = 5)
plotMA(ma_for_BPK25_12h_vs_DMSO, main="MA_plot", ylim=c(-6,6), cex=.8)
abline(h=c(-1,1), col="dodgerblue", lwd=2)
dev.off()
# 保存 MA plot png
png("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_MA_plot.png", width = 700, height = 500)
plotMA(ma_for_BPK25_12h_vs_DMSO, main="MA_plot", ylim=c(-6,6), cex=.8)
abline(h=c(-1,1), col="dodgerblue", lwd=2)
dev.off()

##### 差异基因结果统计概况 #####
degs_for_BPK25_12h_vs_DMSO <- results(dds_filter1_deseq, contrast=c("groups", "BPK25_12h", "DMSO"))
head(degs_for_BPK25_12h_vs_DMSO)
summary(degs_for_BPK25_12h_vs_DMSO)
# out of 23828 with nonzero total read count
# adjusted p-value < 0.1
# LFC > 0 (up)       : 4878, 20%
# LFC < 0 (down)     : 4897, 21%
# outliers [1]       : 5, 0.021%
# low counts [2]     : 462, 1.9%
# (mean count < 1)

###### stat by padj filter ######
table(degs_for_BPK25_12h_vs_DMSO$padj<0.05)
# FALSE  TRUE 
# 14881  8480 
table(degs_for_BPK25_12h_vs_DMSO$padj<0.05 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange >= 0.585)
# FALSE  TRUE 
# 22584  1048 
table(degs_for_BPK25_12h_vs_DMSO$padj<0.05 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange <= -0.585)
# FALSE  TRUE 
# 22190  1524 
table(degs_for_BPK25_12h_vs_DMSO$padj<0.05 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange >= 1)
# FALSE  TRUE 
# 23177   501 
table(degs_for_BPK25_12h_vs_DMSO$padj<0.05 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange <= -1)
# FALSE  TRUE 
# 23357   406 
table(degs_for_BPK25_12h_vs_DMSO$padj<0.01 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange >= 1)
# FALSE  TRUE 
# 23356   322 
table(degs_for_BPK25_12h_vs_DMSO$padj<0.01 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange <= -1)
# FALSE  TRUE 
...
table(degs_for_BPK25_12h_vs_DMSO$pvalue<0.05)
# FALSE  TRUE 
# 13742 10081 
table(degs_for_BPK25_12h_vs_DMSO$pvalue<0.05 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange >= 0.585)
# FALSE  TRUE 
# 22478  1348 
table(degs_for_BPK25_12h_vs_DMSO$pvalue<0.05 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange <= -0.585)
# FALSE  TRUE 
# 22127  1699 
table(degs_for_BPK25_12h_vs_DMSO$pvalue<0.05 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange >= 1)
# FALSE  TRUE 
# 23138   688 
table(degs_for_BPK25_12h_vs_DMSO$pvalue<0.05 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange <= -1)
# FALSE  TRUE 
# 23333   494 
table(degs_for_BPK25_12h_vs_DMSO$pvalue<0.01 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange >= 1)
# FALSE  TRUE 
# 23397   429 
table(degs_for_BPK25_12h_vs_DMSO$pvalue<0.01 & degs_for_BPK25_12h_vs_DMSO$log2FoldChange <= -1)
# FALSE  TRUE 
...
degs_for_BPK25_12h_vs_DMSO_add_nc <- merge(as.data.frame(degs_for_BPK25_12h_vs_DMSO), dds_filter1_normalized_counts[,c("DMSO_rep1","DMSO_rep2","DMSO_rep3","BPK25_12h_rep1","BPK25_12h_rep2","BPK25_12h_rep3","BPK25_12h_rep4","BPK25_12h_rep5","BPK25_12h_rep6")], by="row.names", sort=FALSE)
head(degs_for_BPK25_12h_vs_DMSO_add_nc)
# 对列名进行修改
colnames(degs_for_BPK25_12h_vs_DMSO_add_nc)<- c('gene_id',"baseMean","log2FoldChange","lfcSE","stat","pvalue","padj","DMSO_rep1","DMSO_rep2","DMSO_rep3","BPK25_12h_rep1","BPK25_12h_rep2","BPK25_12h_rep3","BPK25_12h_rep4","BPK25_12h_rep5","BPK25_12h_rep6")
# 增加基因信息
rownames(degs_for_BPK25_12h_vs_DMSO_add_nc) <- degs_for_BPK25_12h_vs_DMSO_add_nc$gene_id
head(degs_for_BPK25_12h_vs_DMSO_add_nc)
degs_all_add_geneInfo <- merge(degs_for_BPK25_12h_vs_DMSO_add_nc, exp_data[,c("gene_name","gene_type")], by="row.names", all.x = TRUE, sort = FALSE)
...
# 输出全部数据
write.table(degs_all_add_geneInfo_sorted, "Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_all_diff_exp_gene_info.xls", sep = '\t', col.names = TRUE, row.names=FALSE, quote = FALSE,na='')

##### 添加上下调标签及过滤结果输出 #####
# 追加 是否显著上下调的标签
res<-degs_for_BPK25_12h_vs_DMSO[which(degs_for_BPK25_12h_vs_DMSO$baseMean >= 0 &  degs_for_BPK25_12h_vs_DMSO$padj >= 0),]
head(res)
...
# 23361     7
# 差异结果追加 经过 DESeq 标准化的 count 表达量
res_add_nc <- merge(as.data.frame(res), dds_filter1_normalized_counts[,c("DMSO_rep1","DMSO_rep2","DMSO_rep3","BPK25_12h_rep1","BPK25_12h_rep2","BPK25_12h_rep3","BPK25_12h_rep4","BPK25_12h_rep5","BPK25_12h_rep6")], by="row.names", all.x = TRUE, sort = FALSE)
head(res_add_nc)
dim(res_add_nc)
# 23361    17
# 对列名进行修改
colnames(res_add_nc)<- c('gene_id',"baseMean" ,"log2FoldChange","lfcSE" ,"stat","pvalue","padj","up_down","DMSO_rep1","DMSO_rep2","DMSO_rep3","BPK25_12h_rep1","BPK25_12h_rep2","BPK25_12h_rep3","BPK25_12h_rep4","BPK25_12h_rep5","BPK25_12h_rep6")
# 增加基因信息
...
# 保存数据
write.table(res_add_nc_add_geneInfo_sorted, "Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_filtered_diff_exp_genes.baseMeanLe0_padjLe0.xls", sep = '\t', col.names = TRUE, row.names=FALSE, quote = FALSE,na='')
...
# 907  19
# 保存数据
write.table(resSig,"Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_filtered_diff_exp_genes.FC2_padj0.05.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')

##### 绘制火山图 #####
# Volcano plot for Comparison2: BPK25_12h_vs_DMSO
library(ggplot2)
BPK25_12h_vs_DMSO <- read.csv("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_filtered_diff_exp_genes.baseMeanLe0_padjLe0.xls",header = TRUE, sep = "\t", check.names = FALSE, stringsAsFactors = FALSE)
BPK25_12h_vs_DMSO$up_down <- factor(BPK25_12h_vs_DMSO$up_down, levels = c("up", "non", "down"))
#
volcano <- ggplot(BPK25_12h_vs_DMSO, aes(x = log2FoldChange, y = -log10(padj))) 
p <- volcano + geom_point(aes(color=up_down), size=1) +
  ...
  # annotate("point", x=BPK25_12h_vs_DMSO[BPK25_12h_vs_DMSO$gene_name=="Mettl14",]$log2FoldChange, y = -log10(BPK25_12h_vs_DMSO[BPK25_12h_vs_DMSO$gene_name=="Mettl14",]$padj), colour="gold", size = 1.5) +
  # annotate("text", x=BPK25_12h_vs_DMSO[BPK25_12h_vs_DMSO$gene_name=="Mettl14",]$log2FoldChange-0.2, y = -log10(BPK25_12h_vs_DMSO[BPK25_12h_vs_DMSO$gene_name=="Mettl14",]$padj)+1.5, label="Mettl14", size=3, color="orange") +
  scale_x_continuous(limits = c(-5, 6), breaks=seq(-5, 6, 1)) +
  ...
  labs(x = "log2FC", y = "-log10(padj)", title = "HEK293_RNA_Seq_BPK25_12h_vs_DMSO Volcano plot") +
...
p
# 保存火山图
ggsave("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_volcano_plot.pdf", p, width = 8, height = 6)
ggsave("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_volcano_plot.png", p, width = 8, height = 6)


#### GSEA for Comparison2: BPK25_12h_vs_DMSO ####
##### 数据准备及预处理 #####
library(dplyr)
library(DOSE)
...
# 读入全部差异基因数据
all_deseq <- read.csv("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_all_diff_exp_gene_info.xls", header = TRUE, sep = "\t", check.names = FALSE, stringsAsFactors = FALSE)
...
write.table(gse_GO_BP_rdb,"Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_BP_reults.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE, na='')

pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_BP_top1_plot.pdf", width = 12, height = 9)
gseaplot2(gse_GO_BP, geneSetID = 1, title = gse_GO_BP$Description[1], pvalue_table = TRUE)
dev.off()
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_BP_top5_plot.pdf", width = 12, height = 9)
...
write.table(gse_GO_CC_rdb,"Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_CC_reults.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')

pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_CC_top1_plot.pdf", width = 12, height = 9)
gseaplot2(gse_GO_CC, geneSetID = 1, title = gse_GO_CC$Description[1], pvalue_table = TRUE)
dev.off()
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_CC_top5_plot.pdf", width = 12, height = 9)
...
write.table(gse_GO_MF_rdb,"Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_MF_reults.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')

pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_MF_top1_plot.pdf", width = 12, height = 9)
gseaplot2(gse_GO_MF, geneSetID = 1, title = gse_GO_MF$Description[1], pvalue_table = TRUE)
dev.off()
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_GO_MF_top5_plot.pdf", width = 12, height = 9)
...
write.table(gse_kegg_rdb,"Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_KEGG_reults.xls",sep = '\t', col.names = TRUE, row.names = FALSE, quote = FALSE,na='')

pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_KEGG_top1_plot.pdf", width = 12, height = 9)
gseaplot2(gse_kegg, geneSetID = 1, title = gse_kegg$Description[1], pvalue_table = TRUE)
dev.off()
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.all_GSEA_KEGG_top5_plot.pdf", width = 12, height = 9)
...
#### GO for Comparison2: BPK25_12h_vs_DMSO ####
##### 数据准备及预处理 #####
library(clusterProfiler)
library(org.Hs.eg.db)
library(topGO)
library(Rgraphviz)
sigDiff_gene_info <- read.table("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO_filtered_diff_exp_genes.FC2_padj0.05.xls",  sep = '\t', header = T, stringsAsFactors = F)
...
geneid_map <-bitr(ensembl_id,
                ...
                OrgDb = org.Hs.eg.db,
                drop = TRUE)
# 35.17%  of input gene IDs are fail to map.
head(geneid_map)
dim(geneid_map)
# 609   2
...
go <- enrichGO(geneid_map$ENTREZID, 
                ...
                keyType = 'ENTREZID', 
                readable = TRUE)
write.table(go,"Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_all_enrichment.results.xls", sep="\t", quote=F, row.names=F)
head(go)
dim(go)
# 169 10
...
# GO ALL bar plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_all_enrichment.barplot.pdf", width = 10, height = 6 )
barplot(go, showCategory=15, title = "GO ALL top15")
dev.off()
# GO ALL dot plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_all_enrichment.dotplot.pdf", width = 10, height = 6 )
...
# 133   9
# GO BP bar plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_BP_enrichment.barplot.pdf", width = 10, height = 6 )
barplot(GO_BP, showCategory=10, title = "GO BP top10")
dev.off()
# GO BP dot plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_BP_enrichment.dotplot.pdf", width = 10, height = 6 )
dotplot(GO_BP, showCategory=10, orderBy = "GeneRatio", title = "GO BP top10")
dev.off()
# GO BP network plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_BP_enrichment.network.pdf", width = 12, height = 12 )
plotGOgraph(GO_BP)
dev.off()
...
# 1 9
# GO CC bar plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_CC_enrichment.barplot.pdf", width = 10, height = 6 )
barplot(GO_CC, showCategory=10, title = "GO CC top10")
dev.off()
# GO CC dot plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_CC_enrichment.dotplot.pdf", width = 10, height = 6 )
dotplot(GO_CC, showCategory=10, orderBy = "GeneRatio", title = "GO CC top10")
dev.off()
# GO CC network plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_CC_enrichment.network.pdf", width = 12, height = 12 )
plotGOgraph(GO_CC)
dev.off()
...
# 35  9
# GO MF bar plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_MF_enrichment.barplot.pdf", width = 10, height = 6 )
barplot(GO_MF, showCategory=10, title = "GO MF top10")
dev.off()
# GO MF dot plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_MF_enrichment.dotplot.pdf", width = 10, height = 6 )
dotplot(GO_MF, showCategory=10, orderBy = "GeneRatio", title = "GO MF top10")
dev.off()
# GO MF network plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_GO_MF_enrichment.network.pdf", width = 12, height = 12 )
plotGOgraph(GO_MF)
dev.off()
...
write.table(kegg_out,"Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_KEGG_enrichme.results.txt", sep="\t", quote=F, row.names=F)
head(kegg_out)
dim(kegg_out)
# 254  11
...
# 20  11
# kegg bar plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_KEGG_enrichme.barplot.pdf", width = 10, height = 6 )
barplot(kegg, showCategory=10, title = "KEGG top10")
dev.off()
# kegg dot plot
pdf("Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO.DEGs_KEGG_enrichme.dotplot.pdf", width = 10, height = 6 )
dotplot(kegg, showCategory=10, title = "KEGG top10")
dev.off()

# 建立 Comparison2_HEK293_RNA_Seq_BPK25_12h_vs_DMSO 文件夹 将差异分析当前对比组的结果移动到这个目录
